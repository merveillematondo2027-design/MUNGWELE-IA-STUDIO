...
export const MarketCashLocalCardPaymentModal: React.FC<MarketCashLocalCardPaymentModalProps> = ({
  target,
  userId,
  userEmail,
  onClose,
      ...
      <div className="max-h-[96vh] w-full max-w-lg overflow-y-auto rounded-[22px] border border-white/10 bg-[#111318] shadow-[0_24px_80px_rgba(0,0,0,0.55)]">
        ...
        <form onSubmit={submit} className="space-y-5 px-5 py-5 sm:px-6 sm:py-6">
          <div className="flex items-start gap-3 rounded-xl border border-white/[0.08] bg-[#171a20] p-3.5">
            ...
            <div>
              <p className="text-sm font-semibold text-white">Carte Market-Cash locale</p>
              <p className="mt-1 text-[12px] leading-5 text-[#8f98a5]">Saisissez votre carte locale ou scannez son QR. Le CVV est toujours saisi manuellement et n’est pas enregistré.</p>
            </div>
          </div>
