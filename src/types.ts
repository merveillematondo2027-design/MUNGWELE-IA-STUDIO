...
export type VideoResolution = '480p' | '720p' | '768p' | '780p' | '1080p' | '1440p' | '2k' | '4k';
...
export type VideoEngineKey = 'veo-lite' | 'veo-fast' | 'veo-pro' | 'omni' | 'seedance-2-5' | 'h3-max' | 'runway-act-two';
